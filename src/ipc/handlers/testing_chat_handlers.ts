...
const TEST_RESPONSES: Record<string, string> = {
  ...
  <mitsu-add-dependency packages="deno"></mitsu-add-dependency>
  
  EOM`,
  "add-non-existing-dep": `I'll add that dependency for you.
  
  <mitsu-add-dependency packages="@angular/does-not-exist"></mitsu-add-dependency>
  
  EOM`,
  "add-multiple-deps": `I'll add that dependency for you.
  
  <mitsu-add-dependency packages="react-router-dom react-query"></mitsu-add-dependency>
  
  EOM`,
  write: `Hello world
  <mitsu-write path="src/hello.ts" content="Hello world">
